import { c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, g as cn, q as o, v as vt, L as Layout, n as LoadingSpinner, s as User, B as Button, M as MapPin, H as House, b as Badge } from "./index-BRrb9eOw.js";
import { C as Card } from "./card-BeDGiw-l.js";
import { I as Input } from "./input-DC7RXpBv.js";
import { P as Primitive } from "./index-DThzL3Nv.js";
import { j as useGetCallerUserProfile, k as useSaveUserProfile, e as useGetDeliveryAddresses, l as useAddDeliveryAddress, m as useUpdateDeliveryAddress, n as useDeleteDeliveryAddress, o as useSetDefaultDeliveryAddress } from "./useBackend-BSOypR0Y.js";
    ...
    Card,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-5 py-4 border-b border-border flex items-center gap-2", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-semibold font-display text-foreground", children: "Personal Info" })
        ] }),
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0 flex-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 flex-wrap", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold text-sm text-foreground truncate", children: address.addressLabel }),
            address.isDefault && /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Badge,
              {
...
function AddressForm({
  ...
  const [form, setForm] = reactExports.useState(initial ?? EMPTY_ADDRESS);
  const set = (f, v2) => setForm((prev) => ({ ...prev, [f]: v2 }));
  const handleSubmit = (e) => {
    e.preventDefault();
    onSave({ ...form, id: initial == null ? void 0 : initial.id });
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "form",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs font-medium text-foreground", children: "Label (e.g. Home, Work)" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Input,
            {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs font-medium text-foreground", children: "Street" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Input,
            {
              className: "h-8 text-sm bg-background",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-3 gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "col-span-1 space-y-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs font-medium text-foreground", children: "City" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Input,
              {
                className: "h-8 text-sm bg-background",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "col-span-1 space-y-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs font-medium text-foreground", children: "State" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Input,
              {
                className: "h-8 text-sm bg-background",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "col-span-1 space-y-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs font-medium text-foreground", children: "ZIP" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Input,
              {
                className: "h-8 text-sm bg-background",
...
function AddressesSection() {
  ...
  const handleUpdate = (data) => {
    if (!editingAddress || data.id === void 0) return;
    updateAddress.mutate(
      ...
      },
      {
        ...
        onError: () => ue.error("Failed to update address")
      }
    );
  };
  const handleDelete = (id) => {
    deleteAddress.mutate(id, {
      onSuccess: () => ue.success("Address removed"),
      onError: () => ue.error("Failed to remove address")
    });
  };
  const handleSetDefault = (id) => {
    setDefault.mutate(id, {
      onSuccess: () => ue.success("Default address updated"),
      onError: () => ue.error("Failed to update default")
    });
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    Card,
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-5 py-4 border-b border-border flex items-center justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-semibold font-display text-foreground", children: "Delivery Addresses" })
          ] }),
          !showForm && !editingAddress && /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Button,
            {
              variant: "outline",
              size: "sm",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-5 py-5 space-y-3", children: [
          isLoading && /* @__PURE__ */ jsxRuntimeExports.jsx(LoadingSpinner, { size: "sm", label: "Loading addresses…" }),
          addresses && addresses.length === 0 && !showForm && /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              className: "text-center py-6 text-muted-foreground",
              "data-ocid": "profile.addresses_empty_state",
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { className: "w-8 h-8 mx-auto mb-2 opacity-40" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm", children: "No saved addresses yet" })
              ]
            }
          ),
          addresses == null ? void 0 : addresses.map(
            (addr, i) => (editingAddress == null ? void 0 : editingAddress.id) === addr.id ? /* @__PURE__ */ jsxRuntimeExports.jsx(
              AddressForm,
              {
                initial: {
...
function ProfilePage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Layout, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-card border-b border-border px-4 py-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-xl mx-auto flex items-center gap-4", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-xl font-bold font-display text-foreground truncate", children: (profile == null ? void 0 : profile.name) || "Your Profile" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground truncate", children: (profile == null ? void 0 : profile.email) || "Manage your account" })
      ] })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-xl mx-auto px-4 py-6 space-y-5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        motion.div,
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsx(ProfileForm, { profile: profile ?? null })
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        motion.div,
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsx(AddressesSection, {})
        }
      )
    ] })
  ] }) });
